  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="${path}/Dashio/responsive_table.html">Responsive Table</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 위험 관리 등록</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel" align="center">
              <form id="frm01" class="form" action="${path}/riskInsert.do">
		  	  <nav class="navbar navbar-expand-sm bg-dark navbar-dark" >
		  	  <br>
		  	  <label class="col-lg-2 control-label">등록자</label>
			  <input name="registrant" class="form-control mr-sm-2" placeholder="등록자 입력" style="width:800px;"/><br>
		  	  <label class="col-lg-2 control-label">위험내용</label>
			  <input name="riskContent" class="form-control mr-sm-2" placeholder="위험내용 입력" style="width:800px;"/><br>
			  
			  
			  <label class="col-lg-2 control-label">위험종류</label>
		      <select name="riskTypeNo" class="form-control" style="width:800px;">
                 <option value="R1000">일정관리</option>
                 <option value="R1001">인적자원</option>
                 <option value="R1002">비용관리</option>
                 <option value="R1003">의사소통관리</option>
                 <option value="R1004">기타</option>
              </select>
              <br>
			  <label class="col-lg-2 control-label">위험도</label>
			  <input name="riskDeg" class="form-control mr-sm-2" placeholder="위험도 입력" style="width:800px;"/><br>
			  <input type="hidden" value="${param.rplanno}" name="rplanno">
			  <div class="buttonEmp">
			  <button class="btn btn-info" onclick="insertProc()" type="button">등록</button>
			  </div>
		 	  </nav>
			  </form>
            </div>
  ...
  <script type="text/javascript">
  	...
  	function insertProc(){
  		if (confirm("등록하시겠습니까?")) {
  			...
  			var riskTypeNoVal = $("[name=riskTypeNo]").val()
  			if (riskTypeNoVal=="") {
  				alert("등록자를 등록하세요")
  				$("[name=riskTypeNo]").focus();
  				return;
  			}
