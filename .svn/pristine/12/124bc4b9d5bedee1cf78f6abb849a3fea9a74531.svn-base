        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel" align="center">
			  ...
			  <input name="registrant" class="form-control mr-sm-2" value="${risk.registrant}" style="width:800px;"/><br>
		      ...
		      <select name="riskTypeNo" class="form-control" style="width:800px;">
                 <option value="R1000" <c:if test="${risk.riskTypeNo eq 'R1000'}">selected</c:if>>일정관리</option>
                 <option value="R1001" <c:if test="${risk.riskTypeNo eq 'R1001'}">selected</c:if>>인적자원</option>
                 <option value="R1002" <c:if test="${risk.riskTypeNo eq 'R1002'}">selected</c:if>>비용관리</option>
                 <option value="R1003" <c:if test="${risk.riskTypeNo eq 'R1003'}">selected</c:if>>의사소통관리</option>
                 <option value="R1004" <c:if test="${risk.riskTypeNo eq 'R1004'}">selected</c:if>>기타</option>
              </select>
              <br>
			  ...
			  <div class="buttonEmp">
			  <button class="btn btn-info" onclick="updateProc()" type="button">수정</button>
			  </div>
		 	  </nav>
			  </form>
            </div>
